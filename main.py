class Student:
    def __init__(self, id, name, theory_score, practice_score, assignment_score):
        ...
        self.academic_type = ""
        # Gọi hai hàm tình điểm trung bình và phân loại mỗi khi tạo. Lúc tạo sẽ tự động cập nhật avg và rank
...
class StudentManager:
    ...
    # Hàm in mỗi sinh viên được truyền vào    
    ...
    # Hàm in tất cả trong self.students
    def show_all(self):
    ...
    #Hàm cập nhật điểm của sinh viên
    ...
    # Hàm tìm kiếm sinh viên theo tên, đảm bảo tính chất gần đúng, lấy được nhiều phần tử khi dùng in và đều ép cả hai vế so sánh thành lower
...
def get_non_empty_string (prompt):
    while True:
        ...
        if not value:
            ...
            continue
        return value
# Hàm bổ trợ để lấy điểm chuẩn, đảm bảo từ 0 -> 10 và là số thực
